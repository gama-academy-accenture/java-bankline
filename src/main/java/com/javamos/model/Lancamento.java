...
public class Lancamento {
	...
	private Conta beneficiario;//conta recebedora ou null, caso ṇo seja uma tranfer̻ncia nem uma receita
	
	@ManyToOne
	@JoinColumn(name = "banco_id")  
	private Conta banco;//conta pagadora ou null, caso ṇo seja uma transfer̻ncia nem uma despesa
